...
function createButton(text, clasess, i){
...
if(listUsers){
    ...
    users.forEach( (u) => {
        ...
        tdAction.appendChild(createButton("v", ["show", "bg-black-50"], i));

        let btR = document.createElement("a");
        tdAction.appendChild(createButton("x", ["remove", "bg-black-50"], i));
...
var btL = document.getElementById("login");
