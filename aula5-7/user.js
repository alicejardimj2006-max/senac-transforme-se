...
if(Ola && logged) Ola.innerHTML = "Olá " + logged.nome 

var listenerUsers = document.getElementById("listenerUsers")
if(listenerUsers)
        listenerUsers.innerHTML = JSON.stringify(users,null,4)
